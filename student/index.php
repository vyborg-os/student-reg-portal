...
//include_once('session.php');
   if (isset($_POST["loguser"])) {
            ...
            $password   = secure(md5($_POST["passwordy"]));
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3"  action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit"><input type="hidden" name="loguser"/>Sign in</button>
                </div>
              </form>
